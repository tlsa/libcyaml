		...
		cyaml_err_t err)
{
	static const char * const strings[CYAML_ERR__COUNT] = {
		...
		[CYAML_ERR_EMPTY_UNION]           = "Mapping union contains no value",
		...
		[CYAML_ERR_UNION_DISC_NOT_FOUND]  = "Bad schema: Referenced union discriminant enum not found.",
		[CYAML_ERR_MULTIPLE_UNION_VALUES] = "Mapping union must have only one field",
